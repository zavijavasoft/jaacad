...
public class RestClient {
    ...
    public void downloadUrl(final String path, final File saveTo, final ProgressListener progressListener)
            throws CancelledDownloadException, DownloadNoSpaceAvailableException, HttpCodeException, IOException {
        new RestClientIO(client, credentials.getHeaders())
                .downloadUrl(path, new FileDownloadListener(saveTo, progressListener));
    }
